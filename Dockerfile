...
# ARG S6_NGINX_VERSION=1.0.0
# ADD https://github.com/socheatsok78/s6-overlay-nginx-module/releases/download/v${S6_NGINX_VERSION}/s6-overlay-nginx-module.tar.zx /tmp
